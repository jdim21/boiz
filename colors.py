colorsDict = {
    ...
    "blobBlush": (255, 174, 201),
    "blobRoseBlush": (237, 28, 36),
    "blobGreen": (117, 249, 77),
    "blobGreenShade": (87, 186, 58),
    "blobGreenLight": (185, 255, 138),
    "blobRose": (255, 174, 201),
    "blobRoseShade": (255, 132, 169),
    "blobRoseLight": (255, 203, 223),
    "blobYellow": (255, 201, 14),
    "blobYellowShade": (255, 127, 39),
    "blobYellowLight": (255, 214, 135),
    "blobBlue": (50, 130, 246),
    "blobBlueShade": (41, 108, 204),
    "blobBlueLight": (89, 165, 255),
    "blobPurple": (188, 121, 255),
    "blobPurpleShade": (128, 0, 255),
    "blobPurpleLight": (205, 155, 255),
    "blobOrange": (255, 128, 0),
    "blobOrangeShade": (213, 106, 0),
    "blobOrangeLight": (255, 164, 72),
    "blobClear": (216, 229, 245, 245),
    "blobClearShade": (157, 170, 205, 245),
    "blobClearLight": (255, 253, 255, 245),
    "typeDevilBlush": (255, 201, 14),
    "typeDevilHornTip": (255, 174, 201),
    "blobShadowLight": (195, 195, 195, 64),
    "blobShadow": (127, 127, 127, 64),

    "blobSparkly": (210, 255, 255),
    "blobSparklyShade": (155, 255, 255),

    "blobPuddle": (68, 141, 186),
    "blobPuddleShade": (58, 121, 158),
    "blobPuddleLight": (128, 205, 249),
    "blobPuddleLightest": (188, 235, 255),

    "blobMud": (121, 61, 0),
    "blobMudShade": (89, 45, 0),
    "blobMudLight": (210, 105, 0),
    "blobMudLightest": (255, 206, 157),

    "stickLight": (240, 240, 240),
    "stickDark": (195, 195, 195),

    "blobSlime": (69, 255, 23),
    "blobSlimeShade": (72, 212, 0),
    "blobSlimeLight": (184, 255, 18),
    "blobSlimeLightest": (223, 252, 33),

    "blobGrass": (34, 177, 76),
    "blobGrassShade": (145, 96, 68),
    "blobGrassLight": (41, 212, 91),
    "blobGrassLightest": (107, 71, 50),

    "blobSand": (236, 204, 162),
    "blobSandShade": (220, 181, 129),
    "blobSandLight": (249, 225, 198),
    "blobSandLightest": (231, 196, 150),

    "hoodieStrings": (195, 195, 195),

    "vikingHatBrown": (121, 61, 0),
    "vikingHatBrownShade": (98, 49, 0),
    "vikingHatHorn": (239, 228, 176),
    "vikingHatHornShade": (227, 208, 119),
    "vikingHatGray": (195, 195, 195),
    "vikingHatGrayShade": (127, 127, 127),
    "vikingHatGrayLight": (224, 224, 224),

    "winterHatBlue": (0, 128, 255),
    "winterHatBlueShade": (0, 105, 210),
    "winterHatBlueBrimLight": (67, 100, 188),
    "winterHatBlueBrimDark": (57, 85, 159),
    "winterHatBlack": (59, 59, 59),
    "winterHatBlackShade": (41, 41, 41),
    "winterHatBlackBrimLight": (81, 81, 81),
    "winterHatBlackBrimDark": (11, 11, 11),
    "winterHatRed": (241, 73, 82),
    "winterHatRedShade": (238, 26, 36),
    "winterHatRedBrimLight": (225, 17, 28),
    "winterHatRedBrimDark": (170, 13, 20),

    "mushroomRed": (237, 28, 36),
    "mushroomRedShade": (155, 13, 20),
    "mushroomRedLight": (243, 114, 120),
    "mushroomWhiteShade": (195, 195, 195),

    "gold": (255, 191, 0),
    "goldLight": (255, 220, 115),
    "goldLightShade": (255, 207, 64),
    "goldDark": (191, 155, 48),
    "goldDarkest": (166, 124, 0),
    "goldNotch": (147, 111, 0),

    "hardhatYellow": (255, 242, 0),
    "hardhatYellowShade": (206, 196, 0),
    ...
    "cloudOutline": (15, 97, 173),
    "cloudShade": (129, 205, 255),
    ...
    "cherryBlossomOutline": (255, 174, 201),
    "cherryBlossom": (255, 214, 231),
    "cherryBlossomLight": (255, 236, 244),
    "cherryBlossomInnerRed": (237, 29, 122),
    "cherryBlossomInnerYellow": (255, 255, 147),
    "cherryBlossomBranch": (148, 22, 45),

    "spotlight": (255, 255, 190, 75),
    "spotlightOuter": (220, 220, 190, 75),

    "redCarpetRed": (223, 17, 28),
    "redCarpetYellow": (232, 220, 0),
    ...
    "coneBrim": (243, 169, 108),
    "coneBrimShade": (232, 145, 76),
    "coneBrimEdge": (133, 71, 41),
    "coneCrossLight": (243, 191, 142),
    "coneCrossDark": (124, 66, 38),
    "cone": (245, 159, 86),
    "coneShade": (194, 107, 65),
    "coneTopShade": (243, 141, 58),
    ...
    "glasses": (0, 162, 232, 150),
    "glassesLight": (0, 162, 232, 150),
